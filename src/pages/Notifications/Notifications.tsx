...
const notificationsSource: NotificationItem[] = [
  ...
  },
  {
    ...
    title: "Rover Issue",
    message:
      "Rover Delta has stopped responding. Please check immediately.",
  ...
  },
  {
    ...
    message:
      "Order ORD-12352 has been assigned to Rover Epsilon.",
  ...
  },
  {
    ...
    message:
      "Rover Gamma scheduled for maintenance at 3:00 PM.",
  ...
  },
  {
    ...
    message:
      "Rover Kappa is now online and ready for assignments.",
  ...
  },
  {
    ...
    title: "Route Delay",
    message:
      "Rover Theta is delayed due to temporary road restrictions.",
  ...
  },
  {
    ...
    message:
      "Rover Beta has completed scheduled maintenance.",
...
const Notifications = () => {
  ...
  const hasLoadedPreviousNotifications =
    visibleCount > INITIAL_VISIBLE_NOTIFICATIONS;

  const hasMorePreviousNotifications =
  ...
  const loadPreviousNotifications = () => {
    setVisibleCount((prev) =>
      Math.min(prev + LOAD_MORE_BATCH_SIZE, allNotifications.length)
    );
  };
      ...
      <div className="w-full max-w-xl rounded-xl border border-border bg-card p-4 shadow-sm">
        ...
        <div className="mb-4 flex items-center gap-2">
          <Button
            size="sm"
            variant={
              activeFilter === "all" ? "secondary" : "ghost"
            }
            className="h-8 rounded-full px-4 text-xs font-semibold"
            onClick={() => setActiveFilter("all")}
          >
          ...
          <Button
            size="sm"
            variant={
              activeFilter === "unread" ? "secondary" : "ghost"
            }
            className="h-8 rounded-full px-4 text-xs font-semibold"
            onClick={() => setActiveFilter("unread")}
          >
